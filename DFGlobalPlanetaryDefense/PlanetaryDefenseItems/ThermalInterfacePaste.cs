namespace DF.GlobalPlanetaryDefense
{
    ...
    [LocDisplayName("Thermal Interface Paste"), LocDescription("This paste is an excellent thermal conductor.")]
    [Serialized, MaxStackSize(50), Weight(100)]
    [Ecopedia("Items", "Products", createAsSubPage: true)]
    public partial class ThermalInterfacePasteItem : Item { }

    [RequiresSkill(typeof(OilDrillingSkill), 5)]
    public partial class ThermalInterfacePasteRecipe : RecipeFamily
    {
        ...
        public ThermalInterfacePasteRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ThermalInterfacePaste",
                displayName: Localizer.DoStr("Thermal Interface Paste"),

                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(GlycerolItem), 2, true),
                    new IngredientElement("CrushedRock", 3, true),
                    new IngredientElement(typeof(CopperHydroxideItem), 25, true)
                },

                items: new List<CraftingElement>
                {
                    new CraftingElement<ThermalInterfacePasteItem>(1)
                }
            );
